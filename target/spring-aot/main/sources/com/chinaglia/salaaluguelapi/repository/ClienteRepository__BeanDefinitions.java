 ...
 */
@Generated
public class ClienteRepository__BeanDefinitions {
  /**
  ...
  public static BeanDefinition getClienteRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ClienteRepository.class, Cliente.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.chinaglia.salaaluguelapi.repository.ClienteRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.chinaglia.salaaluguelapi.repository.ClienteRepositoryImpl__AotRepository(entityManager, context));
      }
    });
