	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
	    return httpSecurity
	            ...
	            .authorizeHttpRequests(authorize -> authorize
	                    ...
	                    .requestMatchers(HttpMethod.GET, "/alugarSala").permitAll()
	                    .requestMatchers(HttpMethod.POST, "/alugarSala").permitAll()
	                    .requestMatchers(HttpMethod.PUT, "/alugarSala/{id}").permitAll()
	                    .requestMatchers(HttpMethod.DELETE, "/alugarSala/{id}").permitAll()
	                    .requestMatchers(HttpMethod.GET, "/sala").permitAll()
	                    .requestMatchers(HttpMethod.POST, "/sala").permitAll()
	                    .requestMatchers(HttpMethod.PUT, "/sala/{id}").permitAll()
	                    .requestMatchers(HttpMethod.DELETE, "/sala/{id}").permitAll()
