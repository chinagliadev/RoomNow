 ...
 */
@Generated
public class SalaAluguelApiApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new SalaAluguelApiApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new SalaAluguelApiApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.chinaglia.salaaluguelapi.infra.security.SecurityConfiguracao");
