...
/**
 * Bean definitions for {@link SalaRepository}.
 */
@Generated
public class SalaRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'salaRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getSalaRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'salaRepository'.
   */
  public static BeanDefinition getSalaRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, SalaRepository.class, Sala.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.chinaglia.salaaluguelapi.repository.SalaRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.SalaRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.chinaglia.salaaluguelapi.repository.SalaRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getSalaRepositoryInstanceSupplier();
