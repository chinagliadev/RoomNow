...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.chinaglia.salaaluguelapi.entity.AluguelSala", "com.chinaglia.salaaluguelapi.entity.Cliente", "com.chinaglia.salaaluguelapi.entity.PessoaFisica", "com.chinaglia.salaaluguelapi.entity.PessoaJuridica", "com.chinaglia.salaaluguelapi.entity.Recurso", "com.chinaglia.salaaluguelapi.entity.Sala", "com.chinaglia.salaaluguelapi.entity.SalaRecurso", "com.chinaglia.salaaluguelapi.entity.Usuario");
